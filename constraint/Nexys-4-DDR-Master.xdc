...
set_property -dict { PACKAGE_PIN T10   IOSTANDARD LVCMOS33 } [get_ports { seg_n[6] }]; #IO_L24N_T3_A00_D16_14 Sch=ca  (a)
set_property -dict { PACKAGE_PIN R10   IOSTANDARD LVCMOS33 } [get_ports { seg_n[5] }]; #IO_25_14 Sch=cb              (b)
set_property -dict { PACKAGE_PIN K16   IOSTANDARD LVCMOS33 } [get_ports { seg_n[4] }]; #IO_25_15 Sch=cc              (c)
set_property -dict { PACKAGE_PIN K13   IOSTANDARD LVCMOS33 } [get_ports { seg_n[3] }]; #IO_L17P_T2_A26_15 Sch=cd     (d)
set_property -dict { PACKAGE_PIN P15   IOSTANDARD LVCMOS33 } [get_ports { seg_n[2] }]; #IO_L13P_T2_MRCC_14 Sch=ce    (e)
set_property -dict { PACKAGE_PIN T11   IOSTANDARD LVCMOS33 } [get_ports { seg_n[1] }]; #IO_L19P_T3_A10_D26_14 Sch=cf (f)
set_property -dict { PACKAGE_PIN L18   IOSTANDARD LVCMOS33 } [get_ports { seg_n[0] }]; #IO_L4P_T0_D04_14 Sch=cg      (g)
...
set_property -dict { PACKAGE_PIN C12   IOSTANDARD LVCMOS33 } [get_ports { btn_rst_n }]; #IO_L3P_T0_DQS_AD1P_15 Sch=cpu_resetn
